...
DIST = r"Disturbance: Increase of 10% in the feed vapor fraction."
DATFOLDER = "dat_source/"
DATFILES = [
    "indirect_c3_+10_feed_vapor_fraction_0.dat",
    "indirect_c3_+10_feed_vapor_fraction_1.dat",
    "indirect_c3_+10_feed_vapor_fraction_2.dat",
]
