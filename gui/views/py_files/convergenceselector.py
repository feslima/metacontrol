...
# Form implementation generated from reading ui file 'ui_files\convergenceselector.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.caseComboBox = QtWidgets.QComboBox(Dialog)
        self.caseComboBox.setEnabled(False)
        self.caseComboBox.setObjectName("caseComboBox")
        self.gridLayout.addWidget(self.caseComboBox, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Select the column name which corresponds to the CASE NUMBER:"))
