...
"}")
        ...
        self.tableViewInputVariables = QtWidgets.QTableView(self.groupBox_3)
        self.tableViewInputVariables.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed|QtWidgets.QAbstractItemView.DoubleClicked|QtWidgets.QAbstractItemView.EditKeyPressed)
        self.tableViewInputVariables.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableViewInputVariables.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        ...
        self.gridLayout_6.addWidget(self.tableViewInputVariables, 1, 1, 1, 3)
