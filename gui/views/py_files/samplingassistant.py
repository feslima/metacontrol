...
"}")
        ...
        self.gridLayout.addWidget(self.groupBox, 0, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.cancelPushButton, 3, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.sampDataPushButton, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.abortSamplingPushButton, 3, 1, 1, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.gridLayout.addLayout(self.horizontalLayout, 4, 1, 1, 7)
...
"}")
        ...
        self.samplerDisplayTableWidget.horizontalHeader().setCascadingSectionResizes(False)
        ...
        self.gridLayout.addWidget(self.groupBox_3, 2, 0, 1, 8)
        ...
        self.gridLayout.addWidget(self.exportCsvPushButton, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.donePushButton, 3, 6, 1, 1)
