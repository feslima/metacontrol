...
DIST = r"Disturbance: Decrease of 2.5% in the feed composition."
DATFOLDER = "dat_source/"
DATFILES = [
    "indirect_c3_-2,5_in_propene_feed_molfrac_0.dat",
    "indirect_c3_-2,5_in_propene_feed_molfrac_1.dat",
    "indirect_c3_-2,5_in_propene_feed_molfrac_2.dat",
]
